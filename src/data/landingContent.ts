...
export const FAQ_ITEMS = [
  ...
  {
    question: 'É uma terapia em grupo?',
    answer:
      'Não. O Existe Mais é um workshop vivencial fundamentado na Psicologia Positiva. Seu foco está no desenvolvimento de recursos, potencialidades e novas possibilidades de ação. Ele não substitui a psicoterapia.',
  },
  {
    question: 'Vou precisar me expor ou compartilhar questões pessoais?',
    answer:
      'Não. A participação acontece sempre dentro dos limites de cada pessoa. As atividades favorecem o autoconhecimento sem exigir compartilhamento de conteúdos pessoais.',
  },
  {
    question: 'É para quem já faz terapia ou também para quem nunca fez?',
    answer: 'Para ambos. Não é necessário conhecimento prévio.',
  },
  {
    question: 'O que posso esperar ao final da experiência?',
    answer:
      'Cada pessoa viverá o workshop de uma forma única. A proposta é favorecer o reconhecimento de capacidades, ampliar possibilidades e cultivar mais esperança, entusiasmo e propósito.',
  },
] as const
